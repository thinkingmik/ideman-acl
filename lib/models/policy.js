...
exports = module.exports = function(bookshelf) {
  var Policy = bookshelf.Model.extend({
    ...
    fetchAllByUserId: function(userId) {
      var rolesTable = bookshelf.getModel('Role').forge().tableName;
      var usersRolesTable = bookshelf.getModel('UserRole').forge().tableName;
  ...
  return bookshelf.getModel('Policy', Policy);
}
